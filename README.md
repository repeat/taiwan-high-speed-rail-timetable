...
* 欄位說明
  * 車次
    ...
    * x2xx: 停靠南港、台北、板橋、台中、台南、左營站（0200, 0203, 0295, 1202 車次除外）
    * 0203: 停靠台北、板橋、台中、嘉義、台南、左營站（不停南港）
    * 0200, 0295: 停靠南港、台北、桃園、台中、嘉義、台南、左營站（不停板橋）
...
## 關於本時刻表
* 本時刻表僅供參考，若和[官方時刻表](http://www.thsrc.com.tw/UploadFiles/TicketFile/1dd47e19-7ff5-485d-9b99-d9eea5ea77a8.pdf "官方時刻表")有所出入，請以官方時刻表為準。
